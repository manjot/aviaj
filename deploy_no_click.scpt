...
if found then
    ...
    tell application "System Events"
        -- Cancel focus on other input fields using Escape
        key code 53 -- Esc
        delay 0.5
        -- Send Ctrl+C to cancel any active state in the terminal
...
delay 5.0
do shell script "screencapture /Users/manjotsingh/.gemini/antigravity/brain/0ffd9276-9383-4dd4-9d79-00c0caf8a296/screenshot_deploy_noclick.png"
