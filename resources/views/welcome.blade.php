...
<body class="bg-[#F8F9FF] text-[#464555] antialiased overflow-x-hidden" x-data="{ mobileMenuOpen: false }">
    ...
    <header class="fixed top-0 inset-x-0 z-50 transition-all duration-300 border-b border-slate-200/50 bg-white/85 backdrop-blur-md">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            <!-- Brand Logo -->
            <a href="/" class="flex items-center space-x-2 text-2xl font-black tracking-tight text-[#0B1C30]">
                <span class="bg-gradient-to-r from-[#3525CD] to-[#6B00B7] bg-clip-text text-transparent uppercase">Ajath</span>
                <span class="text-xs uppercase px-2.5 py-0.5 rounded-full bg-indigo-50 border border-indigo-100 text-[#3525CD] tracking-wider font-semibold">Infotech</span>
            </a>
    ...
    <footer class="py-16 bg-[#0B1C30] text-slate-400 border-t border-white/5 relative z-10">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 pb-12 border-b border-white/5">
                <!-- Branding Info -->
                <div class="space-y-4">
                    <a href="/" class="text-2xl font-black tracking-tight text-white uppercase">
                        Ajath <span class="text-xs uppercase px-2.5 py-0.5 rounded-full bg-white/10 text-white font-semibold">Infotech</span>
                    </a>
