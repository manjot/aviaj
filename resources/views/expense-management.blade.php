...
<head>
    ...
    <title>Expense Dashboard | Aviaj Corporate</title>
    ...
    <main class="max-w-7xl mx-auto px-6 py-10">
        ...
        <section class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                <!-- Upload Receipts CTA -->
                <button type="button" @click="showUploadModal = true" class="flex-1 md:flex-initial px-5 py-2.5 bg-white border border-slate-200 hover:bg-slate-50 hover:border-slate-300 text-slate-800 text-xs font-bold rounded-xl shadow-sm transition-all duration-150 flex items-center justify-center gap-2">
                ...
                <!-- New Report CTA -->
                <button type="button" @click="showReportModal = true" class="flex-1 md:flex-initial px-5 py-2.5 bg-[#59BABA] hover:bg-[#59BABA]/95 text-white text-xs font-bold rounded-xl shadow-md transition-all duration-150 flex items-center justify-center gap-2">
